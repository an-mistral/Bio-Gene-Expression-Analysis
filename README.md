...
- **Expression preprocessing:** Gene-level RNA-seq expression was converted to a DESeq2-compatible integer matrix by rounding. Negative values (if present) were set to zero. Lowly expressed genes were filtered to reduce noise and improve statistical power.
